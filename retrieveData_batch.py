...
class retrieveAPIData :
    ...
    def readFromCSV(self, index):
        ...
        series_sample = series[index-1:index]
    ...
    def retrieveMetaData(self):
        ...
        for v in video:
            ...
            try:    
                ...
                vid_ID.append(v)
                #print (v)
                metalist = [title, thumb, rating, viewcount, author, length, duration, likes, dislikes, description, published, keywords]
                metalist_s = ["title", "thumb", "rating", "viewcount", "author", "length", "duration", "likes", "dislikes", "description", "published", "keywords"]
	    ...
	    success_vid = len(video) - error_vid
        print "Total Video Count: " + str(len(video))
        print "Total Successful Video(s): " + str(success_vid)
        print "Total Unsuccessful Video(s): " + str(error_vid) 
